...
export default function NewProductShopSection({
  section, btnlink,
}: Props) {
  ...
  const buttonLink = section?.button_link ?? btnlink;
    ...
    <section className="container-shop max-sm:pl-0 max-sm:pr-global">
      <div className="flex justify-between items-center mb-6">
        <div className="flex gap-1 pr-4.25 md:pr-0">
          ...
          <h3 className="text-secondary-black-1">
            جدیدترین محصولات
          </h3>
        </div>
        ...
        <div className="flex gap-4 pl-4.25 md:pl-0">
          ...
          <Link href={buttonLink}>
            <>
              <button
                className="hidden md:flex h-[50px] group gap-2 justify-center items-center bg-primary-3/50 py-2 px-4 rounded-[8px] select-none
                hover:rounded-[50px] hover:bg-primary-3 transition-all duration-1000 ease-in-out cursor-pointer"
              >
